...
from app.dependencies.auth import get_optional_user_id, get_current_user_id

client = TestClient(app)
DUMMY_DATE = "2026-01-01T00:00:00Z"

def override_get_optional_user_id():
    return "user-123"
...
def test_delivery_can_update_to_delivered(mock_send, mock_deps):
    mock_sc = mock_deps["staff"]
    def mock_table_select(table_name):
        mock_obj = MagicMock()
        if table_name == "shop_members":
